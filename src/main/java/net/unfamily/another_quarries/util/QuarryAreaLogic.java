...
public final class QuarryAreaLogic {
    ...
    /** Ordered frame positions for O(1) indexed validation slices. */
    public static List<BlockPos> buildFramePositionList(
            BlockPos quarryPos,
            Direction facing,
            int sizeLeft,
            int sizeRight,
    ...
    public static LayerSectionStatus checkLayerSectionsEmpty(
        ...
        for (int i = 0; i < areaChunks.size(); i++) {
            ChunkPos chunkPos = new ChunkPos(areaChunks.getLong(i));
