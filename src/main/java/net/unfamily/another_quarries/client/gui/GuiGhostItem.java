...
public final class GuiGhostItem {
    ...
    public static void render(GuiGraphics graphics, int leftPos, int topPos, Slot slot, ItemStack ghostStack) {
        render(graphics, leftPos, topPos, slot, ghostStack, DEFAULT_ARGB);
    }

    public static void render(GuiGraphics graphics, int leftPos, int topPos, Slot slot, ItemStack ghostStack, int argbColor) {
