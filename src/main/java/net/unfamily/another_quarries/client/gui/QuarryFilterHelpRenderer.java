...
public final class QuarryFilterHelpRenderer {
    ...
    public static void render(GuiGraphics graphics, Font font, int panelMouseX, int panelMouseY, Frame frame) {
        frame.clearExamples();
    ...
    public static void renderExampleTooltip(GuiGraphics graphics, Font font, Frame frame, int mouseX, int mouseY, int leftPos, int topPos) {
        ExampleHit hit = findHit(frame, mouseX, mouseY, leftPos, topPos, font.lineHeight);
        if (hit == null) {
            return;
        }
        graphics.renderComponentTooltip(font, List.of(
                Component.translatable(PREFIX + "click_to_copy"),
                Component.translatable(PREFIX + "paste_hint")), mouseX, mouseY);
    }
    ...
    private static int renderLine(
        ...
        graphics.drawString(font, before, x, y, BODY_COLOR, false);
        ...
        graphics.drawString(font, exampleText, exampleX, y, exampleColor, false);
        if (hovered) {
        ...
        if (!afterText.isEmpty()) {
            graphics.drawString(font, after, exampleX + exampleWidth, y, BODY_COLOR, false);
        }
        return y;
    }
}
